...
describe('UserService', () => {
  ...
  describe('updateProfile', () => {
    ...
    it('should upload new avatar and replace old one', async () => {
      ...
      const res = await service.updateProfile('1', { firstName: 'John' }, file);
    ...
    it('should upload avatar when no old avatar exists', async () => {
      ...
      await service.updateProfile('1', { firstName: 'John' }, {
  ...
  describe('changeRole', () => {
    it('cannot change own role', async () => {
      await expect(service.changeRole('1', Role.ADMIN, '1')).rejects.toThrow(
        BadRequestException,
      );
    });
    ...
    it('user not found', async () => {
      ...
      await expect(service.changeRole('2', Role.ADMIN, '1')).rejects.toThrow(
        NotFoundException,
      );
    });
